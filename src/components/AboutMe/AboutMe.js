    ...
    return (
        <section className="about-me" id="about-me">
            ...
            <div className="about-me__description">
                <h3 className="about-me__description_name">Виктория</h3>
                <p className="about-me__description_about">Фронтенд-разработчик, 23 года</p>
                <p className="about-me__description_text">
                ...
                <a className="about-me__link" href="https://github.com/vikrause" target="_blank" rel="noreferrer">
                    Github
                </a>
            </div>
