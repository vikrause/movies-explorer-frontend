    ...
    return (
        <section className="about-project" id="about-project">
            ...
            <div className="about-project__caption">
                <div className="about-project__caption_text about-project__caption_text_back_end">
                    Back-end
                </div>
                <div className="about-project__caption_text about-project__caption_text_front_end">
                    Front-end
                </div>
            </div>
        </section>
