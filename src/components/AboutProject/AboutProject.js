    ...
    return (
        <section className="about-project" id="about-project">
            ...
            <div className="about-project__duration">
                <div className="about-project__weeks about-project__weeks_one">1 неделя</div>
                <div className="about-project__weeks about-project__weeks_four">4 недели</div>
            </div>
            <div className="about-project__caption">
                <div className="about-project__caption_text about-project__caption_text_back_end">Back-end</div>
                <div className="about-project__caption_text about-project__caption_text_front_end">Front-end</div>
            </div>
        </section>
    )
}